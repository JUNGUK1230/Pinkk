...
echo "로봇 bridge 시작: speed=${SPEED}, tolerance=${GOAL_TOLERANCE_DEG}deg, joint_enabled=${JOINT_EXECUTION_ENABLED}, cartesian_enabled=${CARTESIAN_EXECUTION_ENABLED}, cartesian_max=${CARTESIAN_MAX_TRANSLATION_M}m"
