...
static const _Keypoint2D_type_support_symbol_names_t _Keypoint2D_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pinkk_usb_insertion_interfaces, msg, Keypoint2D)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pinkk_usb_insertion_interfaces, msg, Keypoint2D)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pinkk_usb_insertion_interfaces, msg, Keypoint2D)() {
  return &::pinkk_usb_insertion_interfaces::msg::rosidl_typesupport_c::Keypoint2D_message_type_support_handle;
}
