...
#include "pinkk_usb_insertion_interfaces/msg/detail/keypoint2_d__rosidl_typesupport_fastrtps_c.h"
...
using _Keypoint2D__ros_msg_type = pinkk_usb_insertion_interfaces__msg__Keypoint2D;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pinkk_usb_insertion_interfaces__msg__Keypoint2D;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const pinkk_usb_insertion_interfaces__msg__Keypoint2D * ros_message = static_cast<const pinkk_usb_insertion_interfaces__msg__Keypoint2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_pinkk_usb_insertion_interfaces__msg__Keypoint2D(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  pinkk_usb_insertion_interfaces__msg__Keypoint2D * ros_message = static_cast<pinkk_usb_insertion_interfaces__msg__Keypoint2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_pinkk_usb_insertion_interfaces__msg__Keypoint2D(cdr, ros_message);
}

static uint32_t _Keypoint2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pinkk_usb_insertion_interfaces__msg__Keypoint2D(
...
static size_t _Keypoint2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pinkk_usb_insertion_interfaces__msg__Keypoint2D(
