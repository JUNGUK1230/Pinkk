...
static const _Keypoint2D_type_support_symbol_names_t _Keypoint2D_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pinkk_usb_insertion_interfaces, msg, Keypoint2D)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pinkk_usb_insertion_interfaces, msg, Keypoint2D)),
  }
};
...
{
  return &::pinkk_usb_insertion_interfaces::msg::rosidl_typesupport_cpp::Keypoint2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pinkk_usb_insertion_interfaces, msg, Keypoint2D)() {
  return get_message_type_support_handle<pinkk_usb_insertion_interfaces::msg::Keypoint2D>();
}
