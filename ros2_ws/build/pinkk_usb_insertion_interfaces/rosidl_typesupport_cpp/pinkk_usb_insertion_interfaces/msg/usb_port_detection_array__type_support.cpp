...
static const _UsbPortDetectionArray_type_support_symbol_names_t _UsbPortDetectionArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pinkk_usb_insertion_interfaces, msg, UsbPortDetectionArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pinkk_usb_insertion_interfaces, msg, UsbPortDetectionArray)),
  }
};
...
{
  return &::pinkk_usb_insertion_interfaces::msg::rosidl_typesupport_cpp::UsbPortDetectionArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pinkk_usb_insertion_interfaces, msg, UsbPortDetectionArray)() {
  return get_message_type_support_handle<pinkk_usb_insertion_interfaces::msg::UsbPortDetectionArray>();
}
